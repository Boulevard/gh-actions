...
const coverageJson = _actions_core__WEBPACK_IMPORTED_MODULE_0__.getInput("coverage", { required: true });
...
const percent = [Object.values(coverage.total)]
    ...
    .shift();
_actions_core__WEBPACK_IMPORTED_MODULE_0__.setOutput("percent", percent);
